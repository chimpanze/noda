...
func (d *findOneDescriptor) ConfigSchema() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"having":       map[string]any{"type": []any{"string", "object"}, "description": "HAVING clause. Prefer {\"query\": ..., \"params\": [...]}; a bare string is deprecated"},
			"limit":        map[string]any{"type": "integer", "description": "Maximum rows to consider before LIMIT 1 is applied"},
